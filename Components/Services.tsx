        ...
        <div data-aos="fade-right">
            ...
            uppercase font-semibold text-center p-[2rem]'>
                ...
                <p className='text-[15px] text-[#d3d2d2] font-normal'>
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eligendi eos adipisci 
                    tempora exercitationem nemo accusantium repudiandae error magni aut quia, obcaecati, sunt harum, nulla voluptas cupiditate facilis ut in minima!
                </p>
            </div>
        </div>
